...
| ~~K-P~~ | ~~**Operator yordamchi APK'si**~~ → **qurildi va chiqarildi 2026-09-14** (`apps/operator-android`, 10 test, `taxi.birjoy.online/1067-taxi-operator.apk`). Ega sababi: **kuniga 200 buyurtma**. Qolgani — **SIM'li qurilmada sinash** | 0 | `CallMachine.kt` · panel: Sozlamalar → Telefonlar |
