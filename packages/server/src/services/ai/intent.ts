...
const FAQ: { re: RegExp; a: string }[] = [
  ...
  { re: /garaj|гараж|mashina\s+sot/i, a: "🚗 Garaj: tanga evaziga mashina oling — u siz TAKSIDA yurganingizda daqiqasiga tanga ishlab beradi. Mini App → Bonus." },
  { re: /g'ildirak|gildirak|ruletka|spin/i, a: "🎡 Omad g'ildiragi SAFAR PAYTIDA aylanadi — har safar 1 spin, har spin yutadi!" },
  { re: /plus|obuna/i, a: "💎 1067 Plus: 9 990 tanga/oy — cashback ×1.5 va Garaj +20%. Birinchi oy BEPUL. Mini App → Bonus." },
