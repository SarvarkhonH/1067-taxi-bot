...
const SUITES = [
  ...
  "testAdminMoveBalance.ts", // 💼 admin move tanga→kas balance (NO daily cap) · atomic deduct never <0 · refund on kas-fail
  "testRideWheel.ts", // 🎰 baraban: 5-min token · one spin/token · clamp-safe key · EV≈283 distribution · jackpot rare
];
