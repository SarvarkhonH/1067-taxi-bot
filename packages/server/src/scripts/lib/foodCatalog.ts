...
const MARKET: SeedProduct[] = [
  // Un va yorma
  { shop: "market", name: "Oliy nav un", cat: "Un va yorma", unit: "1 kg", price: 11000, art: { form: "qop", c1: "#f8fafc", c2: "#e2e8f0", c3: "#b45309", glyph: "bugdoy" } },
  ...
  { shop: "market", name: "Lazer guruch", cat: "Un va yorma", unit: "1 kg", price: 20000, art: { form: "qop", c1: "#fef3c7", c2: "#fde68a", c3: "#b45309", glyph: "bugdoy" } },
  ...
  // Dukkaklilar
  { shop: "market", name: "Mosh", cat: "Dukkaklilar", unit: "1 kg", price: 25000, art: { form: "dukkakli", c1: "#4d7c0f", c2: "#e2e8f0" } },
  { shop: "market", name: "No'xat", cat: "Dukkaklilar", unit: "1 kg", price: 25000, art: { form: "dukkakli", c1: "#d6b56b", c2: "#e2e8f0" } },
  { shop: "market", name: "Oq loviya", cat: "Dukkaklilar", unit: "1 kg", price: 22000, art: { form: "dukkakli", c1: "#f1f5f9", c2: "#cbd5e1" } },
...
const BOZOR: SeedProduct[] = [
  // Sabzavotlar
  { shop: "bozor", name: "Kartoshka", cat: "Sabzavotlar", unit: "1 kg", price: 5000, art: { form: "piyoz", c1: "#d9b382", c2: "#8b5a2b" } },
  ...
  { shop: "bozor", name: "Pomidor", cat: "Sabzavotlar", unit: "1 kg", price: 5000, art: { form: "mevaDumaloq", c1: "#dc2626", c2: "#3f7d34" } },
  { shop: "bozor", name: "Bodring", cat: "Sabzavotlar", unit: "1 kg", price: 8000, art: { form: "ildiz", c1: "#4d7c0f", c2: "#22c55e" } },
  { shop: "bozor", name: "Bulg'or qalampiri", cat: "Sabzavotlar", unit: "1 kg", price: 8000, art: { form: "mevaDumaloq", c1: "#f59e0b", c2: "#3f7d34" } },
  { shop: "bozor", name: "Baqlajon", cat: "Sabzavotlar", unit: "1 kg", price: 6500, art: { form: "ildiz", c1: "#6b21a8", c2: "#3f7d34" } },
  ...
  { shop: "bozor", name: "Sarimsoq", cat: "Sabzavotlar", unit: "250 g", price: 16000, art: { form: "piyoz", c1: "#f1f5f9", c2: "#65a30d" } },
  ...
  { shop: "bozor", name: "Oshqovoq", cat: "Sabzavotlar", unit: "1 kg", price: 5000, art: { form: "mevaDumaloq", c1: "#f97316", c2: "#3f7d34" } },
  // Mevalar
  ...
  { shop: "bozor", name: "Nok", cat: "Mevalar", unit: "1 kg", price: 24000, art: { form: "mevaDumaloq", c1: "#d4d94a", c2: "#3f7d34" } },
  { shop: "bozor", name: "Banan", cat: "Mevalar", unit: "1 kg", price: 21000, art: { form: "banan", c1: "#facc15", c2: "#a16207" } },
  ...
  { shop: "bozor", name: "Qora uzum", cat: "Mevalar", unit: "1 kg", price: 15000, art: { form: "uzum", c1: "#6b21a8", c2: "#3f7d34" } },
  { shop: "bozor", name: "Husayni uzum", cat: "Mevalar", unit: "1 kg", price: 20000, art: { form: "uzum", c1: "#a3e635", c2: "#3f7d34" } },
  { shop: "bozor", name: "Anor", cat: "Mevalar", unit: "1 kg", price: 22000, art: { form: "mevaDumaloq", c1: "#b91c1c", c2: "#3f7d34" } },
  { shop: "bozor", name: "Shaftoli", cat: "Mevalar", unit: "1 kg", price: 18000, art: { form: "mevaDumaloq", c1: "#fb7185", c2: "#3f7d34" } },
  { shop: "bozor", name: "O'rik", cat: "Mevalar", unit: "1 kg", price: 18000, art: { form: "mevaDumaloq", c1: "#fbbf24", c2: "#3f7d34" } },
  { shop: "bozor", name: "Tarvuz", cat: "Mevalar", unit: "1 kg", price: 3500, art: { form: "mevaDumaloq", c1: "#16a34a", c2: "#14532d" } },
